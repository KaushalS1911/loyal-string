...
const TABLE_HEAD = [
  ...
  { id: 'CounterLoginStatus', label: 'Counter Login Status' },
  { id: 'CounterDescription ', label: 'Counter Description ' },
  { id: '', width: 88 },
];
...
export default function CounterListView() {
  ...
  const handleDelete = async (id) => {
    try {
      const res = await axios.delete(`${ASSETS_API}/api/company/${user?.company}/counter`, {
        data: { ids: id },
      });
